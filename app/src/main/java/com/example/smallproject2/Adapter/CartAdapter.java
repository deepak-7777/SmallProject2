...
import com.example.smallproject2.databinding.ViewholderCartBinding;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull CartAdapter.Viewholder holder, int position) {
        ...
        holder.binding.totalEachItem.setText("$" + Math.round(
                listItemSelected.get(position).getPrice() * listItemSelected.get(position).getNumberinCart()));
